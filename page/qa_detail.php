            ...
            <aside class="right-side">                
				...
				<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">QA Audit details</h3>
                                </div><!-- /.box-header -->
										...
										<tr>
												...
												<th>Feedback</th>
												  ...
												  <?php 
													...
													$query = $db->prepare("select * from qa where agent_id = :username");
													...
													foreach($result as $row)
													{
													 ...
													 echo "<td>" . $row['audit_score'] . "</td>";
													 echo "<td>" . $row['audit_date'] . "</td>";
													 echo "<td>" . $row['audit_casenumber'] . "</td>";
													 echo "<td>" . $row['audit_type'] . "</td>";
													 echo "<td>" . $row['audited_by'] . "</td>";
													 echo "<td>" . $row['audit_notes'] . "</td>";
													 echo "</tr>";
													 }
													 ?>
