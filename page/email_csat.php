            ...
            <aside class="right-side">                
				...
				<div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Email CSAT Details</h3>
                                </div><!-- /.box-header -->
										...
										<tr>
												...
												<th><center>Verbatim</center></th>
												  ...
												  <?php 
													...
													$query = $db->prepare("select * from csat_dump where `SBT Agent` = :username and `SBT Channel Name` = 'email'");
													...
													foreach($result as $row)
													{
													 ...
													 {echo "<td><span class='label label-danger'>DSAT</span></td>";}
													 else 
													 {echo"<td><span class='label label-success'>CSAT</span></td>";}
													 if($row['FCR'] == 0)
